...
import us.ihmc.commonWalkingControlModules.trajectories.InitialClearancePositionTrajectoryGenerator;
...
public class InitialClearancePositionTrajectoryGeneratorVisualizer
{
   ...
   public InitialClearancePositionTrajectoryGeneratorVisualizer()
   {
      YoGraphicsListRegistry yoGraphicsListRegistry = new YoGraphicsListRegistry();

      traj = new InitialClearancePositionTrajectoryGenerator("Traj", aFrame, registry, true, yoGraphicsListRegistry);
      traj.setInitialPosition(0.0, 0.0, 1.0);
      traj.setFinalPosition(1.0, 0.0, 1.0);
      traj.setInitialClearance(new FrameVector3D(aFrame, 0.0, 1.0, 1.0), 0.1);
   ...
   {
      new InitialClearancePositionTrajectoryGeneratorVisualizer();
   }
}
