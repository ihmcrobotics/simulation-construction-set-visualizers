...
public class Box3DSTPBoundingVolumeVisualizer extends Application
{
   @Override
...
//         box3D.getPose().setToZero();
         ...
         view3dFactory.addNodeToView(Shape3DSTPBoundingVolumeMeshBuilder.toSTPBox3DMesh(stpBox,
